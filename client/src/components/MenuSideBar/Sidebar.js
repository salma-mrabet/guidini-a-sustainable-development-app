...
function MyComponent() {
    return (
      <div style={{marginLeft:'-25px'}} className="bg-gray-100 h-screen flex justify-center items-center">
        <div style={{width:'150px'}} className="ml-6 flex w-16 flex-col items-center space-y-10 py-6">
          ...
          <div className="space-y-48 rounded-md bg-white">
            <ul style={{listStyle:'none'}}>
              <li className="p-5" style={{marginLeft:'-50px'}}>
            ...
            <div style={{marginLeft:'15px'}}className="flex items-center justify-center pb-5">
